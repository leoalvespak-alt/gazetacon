...
export default function CreateProvaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await createProva(formData)
    
    if (result.error) {
      toast.error("Erro ao criar prova", { description: result.error })
      setLoading(false)
    } else {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Adicione uma prova ao banco de provas
          </p>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button type="button" variant="outline" className="w-full" asChild>
                  <Link href="/admin/provas">Cancelar</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ConcursoSelector
                  ...
                  onChange={(id) => updateField("concurso_id", id)}
